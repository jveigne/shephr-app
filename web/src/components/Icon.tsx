...
const PATHS: Record<string, string> = {
  dashboard: 'M3 13h6v8H3zM3 3h6v8H3zM13 11h8v10h-8zM13 3h8v6h-8z',
  donation: 'M12 1v22M17 5H9.5a3.5 3.5 0 000 7h5a3.5 3.5 0 010 7H6',
  building: 'M3 21V6a2 2 0 012-2h6a2 2 0 012 2v15M3 21h18M13 8h6a2 2 0 012 2v11M8 8h.01M8 12h.01M8 16h.01M16 12h.01M16 16h.01',
  users: 'M17 21v-2a4 4 0 00-4-4H5a4 4 0 00-4 4v2M9 11a4 4 0 100-8 4 4 0 000 8zM23 21v-2a4 4 0 00-3-3.87M16 3.13a4 4 0 010 7.75',
  hierarchy: 'M6 3v12M18 9v12M6 21h12M3 6h6M15 6h6M3 18h6M15 18h6M9 9h6',
...
export function Icon({ name, size = 18, className, style }: IconProps & { name: string }) {
  const d = PATHS[name];
  if (!d) return null;
  return (
    <svg
