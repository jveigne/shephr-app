// ISO 3166-1 : code alpha-2 → code numérique (string à 3 chiffres).
// Sert à faire correspondre les nations renvoyées par le backend (alpha-2)
// avec les géométries de world-atlas (countries-110m), dont l'id est le code numérique.
